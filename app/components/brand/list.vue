<template>
  <UContainer>
    <div class="hidden md:block md:flex justify-end mb-2">
      <UButton
    ...
    <div class="flex justify-between gap-6">
      ...
      <div class="hidden md:flex flex-col w-1/5 sticky top-20 h-fit self-start gap-4">
        <!-- Skeleton state for the entire left sidebar -->
        ...
        <template v-else>
          ...
          <div class="mt-4">
            ...
            <div class="flex flex-wrap gap-1 max-h-50 overflow-y-scroll">
              <UButton
      ...
      <div class="flex-1" keep-alive>
        <div
          class="grid grid-cols-1 md:grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-2"
          v-if="pending"
        >
          <div
            v-for="n in 8"
          ...
          >
            ...
            <div class="p-4 flex flex-col gap-3">
              ...
              <div class="flex gap-2 mt-2 mt-auto">
        ...
        <div
          class="grid grid-cols-1 md:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 gap-6"
...
<script setup>
  ...
  async function getbrands() {
    ...
    const globalSearch = route.query.q || ''
    const localSearch = searchQuery.value

    if (localSearch || globalSearch) {
      const searchVal = localSearch || globalSearch
      if (globalSearch && !localSearch) {
        // Unified search for header (name, category)
        baseFilters.push({
          _or: [
